...
In this project, predictive models for determining medical expenses based on certain patient characteristics were developed and compared. The selected model - Model 4, which is an improved model including an added non-linear relationship (`age2`), a transformed variable (`bmi30`) and an interaction relationship (`bmi30:smoker`) was determined to have the better fit to the dataset among the models, evident from its smallest RSE (4490) and highest adjusted RSE (0.87). 
